...
const DEFAULT_TITLE = "Precision - Component-based content architecture for a research platform";
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Precision - Component-based content architecture for a research platform",
      },
    ],
  },
  twitter: {
